...
void openRecords() {
    ...
    if (MyFile.is_open()) {
        ...
        while (currentNode != nullptr) {
            Player player = currentNode->player;
            MyFile << "Nickname: " << player.nickname << "," << "Age: " <<  player.age << "," << "Score 1: " << player.score1 << "," << "Score 2: " << player.score2 << endl;
            currentNode = currentNode->next;
        }
        cout << "Records opened successfully!" << endl;
    }
    else {
